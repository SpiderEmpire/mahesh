...
<body>
	...
	<div align="justify"
		style="font-size: 18px; margin-left: 20%; margin-right: 20%">
				<h1 style="font-size: 22px;">Add New Public Notice</h1>

			<form method="post" action="PublicNotice">

			<table>
				
				<tr>
					<td>Notice Date</td>
					<td><input class="date" type="date" name="date"							
											required="" placeholder="dd-mmm-yyyy"/></td>
				</tr>						
